...
<body>
    <div class="sticky top-0 px-2 pt-2">
        <a href="{{ route('properties')}} " type="button" class="w-32 border-none flex gap-2 h-8 bg-gray-200 rounded px-3 items-center hover:bg-gray-300">
            <svg class="fill-current" height="20" viewBox="0 0 512.00533 512" width="20" xmlns="http://www.w3.org/2000/svg">
